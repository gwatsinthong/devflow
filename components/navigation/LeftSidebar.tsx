...
const LeftSidebar = () => {
  return <section className="custom-scrolllbar background-light900_dark200 light-border sticky lrft-0 top-0 h-screen flex flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
